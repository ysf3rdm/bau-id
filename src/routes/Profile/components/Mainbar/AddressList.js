...
export default function AddressList({ className }) {
  return (
    <div
      className={cn(
        'bg-[rgba(72,143,139,0.25)] rounded-[24px] flex px-8 py-4',
        className
      )}
    >
      <div className="grid grid-cols-3 gap-x-4 px-4 border-r border-[rgba(204,252,255,0.2)]">
      ...
      <div className="bg-[rgba(204,252,255,0.2)] rounded-[89px] px-[43px] py-2 text-center text-white ml-4">
